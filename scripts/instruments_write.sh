...
FILE_PATH="$PROJECT_ROOT/rocksgraph/bench_data/snap/soc-LiveJournal1-1M.txt"
...
cargo instruments -t cpu  --bin bench_write --release -- --data-dir "$STORE_DIR"  --file-path "$FILE_PATH"  --parallelism $PARALLELISM "$@"
