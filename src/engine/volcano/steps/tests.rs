...
mod cases {
    use crate::{
        ...
        planner::{
            ...
            logical_step::{
                ...
                DropStep as LogicalDropStep, EmitSpec, HasIdStep as LogicalHasIdStep,
                HasLabelStep as LogicalHasLabelStep,
                ...
                PropertyStep as LogicalPropertyStep, RepeatStep as LogicalRepeatStep,
                ScalarFilterStep as LogicalScalarFilterStep,
    ...
    fn test_repeat_times_n_hop() {
        ...
        let body = LogicalPlan {
            steps: vec![LogicalStep::Out(LogicalOutStep { labels: smallvec![], end_vertex_ids: None })],
        };
        let logical_plan = LogicalPlan {
            steps: vec![
                LogicalStep::V(LogicalVStep { ids: smallvec![1] }),
    ...
    fn test_repeat_emit_all_intermediates() {
        ...
        let mut ids: Vec<i64> =
            results.iter().map(|v| if let GValue::Vertex(id) = v { *id } else { 0 }).collect();
        ids.sort();
