...
//! Physical step test cases for the volcano engine.
...
fn test_has_property_step_match_edge() {
    ...
    let created_edge_key = CanonicalEdgeKey { src_id: josh_id, label_id: CREATED_LABEL_ID, rank: 0, dst_id: ripple_id }; // Josh created Ripple has weight 1
